            ...
            <form wire:submit.prevent="register">
                ...
                <div class="grid sm:grid-cols-12 gap-6">
                    ...
                    <div class="sm:col-span-12 lg:col-span-4">
                        ...
                        <input wire:model.live="autoDialerModule" id="autoDialerModule" type="checkbox" {{ $autoDialerModule ? 'checked' : '' }}
                    ...
                    <div class="sm:col-span-12 lg:col-span-4">
                        ...
                        <input wire:model.live="autoDistributorModule" id="autoDistributorModule" type="checkbox" {{ $autoDistributorModule ? 'checked' : '' }}
                            class="mt-1 block rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                    ...
                    <div class="sm:col-span-12 lg:col-span-4">
                        ...
                        <input wire:model.live="evaluationModule" id="evaluationModule" type="checkbox" {{ $evaluationModule ? 'checked' : '' }}
                            class="mt-1 block rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                    ...
                    <div class="sm:col-span-12 lg:col-span-8">
                        ...
                        <select
                            ...
                            wire:model="status">
                            <option value="" disabled>Determine Status of License</option>
                    ...
                    <div class="sm:col-span-12 lg:col-span-8">
                        ...
                        <div class="max-w-sm space-y-3">
                            <textarea
                                ...
                                placeholder="Write Licene Description over here ... (Optional)">{{ $description }}</textarea>
                        </div>
                ...
                <div class="mt-6 flex justify-end gap-4">
                    ...
                    <x-styled-button :type="'button'" :value="'Save Changes'" :livewire="'updateLicense()'" />
